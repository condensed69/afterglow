...
| Stage | *Removed in 0.16.0 (was: CSS stage set — lighting, haze, crowd silhouettes, marquee, lip — no performer figure).* Now: action bar (Work the room + Buy a round + bar/DJ station buttons), second row (Main Stage line, Room energy %, golden-ticket VIP badge), Night log |
